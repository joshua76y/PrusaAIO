...
#define X_MIN_ENDSTOP_INVERTING PRUSA_AIO_XY_ENDSTOP_INVERTING // Set to true to invert the logic of the endstop.
#define Y_MIN_ENDSTOP_INVERTING PRUSA_AIO_XY_ENDSTOP_INVERTING // Set to true to invert the logic of the endstop.
...
#define PRINTCOUNTER
  ...
  #define PRINTCOUNTER_SAVE_INTERVAL PRUSA_AIO_PRINTCOUNTER_SAVE_INTERVAL // (minutes) EEPROM save interval during print. A value of 0 will save stats at end of print.
#endif
