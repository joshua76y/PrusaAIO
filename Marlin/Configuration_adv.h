...
//#define INPUT_SHAPING
  ...
  #define SHAPING_FREQ_X PRUSA_AIO_SHAPING_FREQ_X  // (Hz) The dominant resonant frequency of the X axis.
  #define SHAPING_FREQ_Y PRUSA_AIO_SHAPING_FREQ_Y  // (Hz) The dominant resonant frequency of the Y axis.
